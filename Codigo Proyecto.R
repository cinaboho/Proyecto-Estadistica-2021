title: 'Proyecto de Estadística: Análisis de Pruebas de Hepatitis tipo C'
author: "CRISTIAN ARREAGA , DIEGO BERREZUETA , CINDY BOHORQUEZ , JEIMY QUIMI  "
date: "11/21/2020"

---
  
  #Proyecto de Estadística: Análisis de Pruebas de Hepatitis tipo C
...
# Primer Objetivo :
#Verificar si existe asociación estadística entre el tipo de la enfermedad y el sexo de la persona.
...
#2. Verificar si existe asociación estadística entre el tipo de la enfermedad y la edad de la persona.
